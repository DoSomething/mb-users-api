...
var getAllUsers = function(request, response, self) {
  ...
  query.exec(function(err, docs) {
    ...
    var previous_page_url = request.protocol + '://' + request.get('host') + request.path + '?type=cursor&min_id=' + min_id + '&page_size=' + data.page_size;
    var next_page_url = request.protocol + '://' + request.get('host') + request.path + '?type=cursor&max_id=' + max_id + '&page_size=' + data.page_size;
