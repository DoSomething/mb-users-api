...
var getAllUsers = function(request, response, self) {
  ...
  function(err, queriesResult) {
    ...
    console.log("responseData.meta.min_id: " + responseData.meta.min_id);
    console.log("responseData.meta.collection_min_id: " + responseData.meta.collection_min_id);

    if (responseData.meta.min_id != responseData.meta.collection_min_id) {
      var previous_page_url = request.path + '?type=cursor&min_id=' + responseData.meta.min_id + '&page_size=' + responseData.meta.page_size;
      responseData.meta.previous_page_url = previous_page_url;
    }

    if (responseData.meta.max_id != responseData.meta.collection_max_id) {
      var next_page_url = request.path + '?type=cursor&max_id=' + responseData.meta.max_id + '&page_size=' + responseData.meta.page_size;
